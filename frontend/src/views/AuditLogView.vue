...
const modules = ['AUTH', 'USERS', 'EQUIPOS', 'DOTACIONES', 'UPLOAD', 'PROYECTOS', 'REPORTES', 'CIUDADANIA_SERIE'];
const actions = [
  ...
  'SOLICITUD_SERIE_VERIFICADA', 'SOLICITUD_SERIE_NO_COINCIDE',
  'SOLICITUD_SERIE_APROBADA', 'SOLICITUD_SERIE_RECHAZADA',
];
